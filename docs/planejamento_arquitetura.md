...
| Campo | Valor |
| --- | --- |
| Fase corrente | **Fase 7 completa (7c.1/7c.2/7c.3 construídas + revisadas + validadas local)** — aguarda **deploy**; depois **Fase 8** |
| Última atualização | 2026-07-20 |
| Bloqueios ativos | Nenhum |
| Próximo passo imediato | **Deploy da 7c** (backend+frontend, sem migration) + validação visual no browser (túnel Tailscale `8090`): dashboard, cadastros (agendar, criar paciente/responsável via wizard), menu de perfil. Depois **Fase 8 (Automação n8n & Backups, §4.2)** — plano + perguntas antes de codar. |
