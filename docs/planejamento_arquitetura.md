...
**Smoke pós-rotação (2026-08-06):** o receptor foi publicado temporariamente, passou
...
**Homarr (2026-08-06):** o operador decidiu remover o serviço em vez de aguardar nova
release. Foram removidos o contêiner legado, os dois volumes exclusivos, a rede exclusiva
e as imagens legada/candidata. O snapshot Restic `707f30a5` permanece como rollback; não
há candidato em execução nem bloqueio Homarr para a Agenda.
...
- 2026-08-06 — [Fase 9/Homarr] ✅ **Homarr removido.** Contêiner, volumes, rede e imagens foram apagados após confirmação de exclusividade; snapshot `707f30a5` preserva recuperação. Agenda/n8n permaneceram saudáveis e o runtime fechou em `0` erros/`0` avisos.
