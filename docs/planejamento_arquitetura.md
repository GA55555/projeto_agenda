...
**Onde paramos (2026-07-28):** o n8n foi inventariado e incluído no recovery coordenado. O snapshot `aa64be52` validou dump/globals dos dois PostgreSQL, documentos, volume persistente e chave/configuração do n8n, fonte e checksums. O bundle `4bd3dd57` preservou as cinco imagens efetivamente executadas após provar o bloqueio de proveniência e reconstruir backend/frontend no commit `4965916`. Todos os serviços voltaram saudáveis e o staging foi desmontado. A assinatura explícita e imutável está implantada na migration `0011`. **Retomar por:** restaurar o conjunto n8n isoladamente, sem rede externa e sem ativar workflows; segunda cópia offline/off-site, retenção, RTO e restore em host separado permanecem pendentes de hardening.
