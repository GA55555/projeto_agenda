...
- [~] Observabilidade mínima: `infra/observabilidade/verificar_runtime.sh` monitora
  ...
  Baseline de 2026-08-05: `0` erros, memória máxima ~40%, disco 65% e aviso único porque
  os seis containers usam `json-file` sem rotação. Compose Agenda prepara `10m × 5`,
  ainda sem recriação; stack n8n, alerta externo e responsável/timer permanecem pendentes.
