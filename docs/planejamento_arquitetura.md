...
| Próximo passo imediato | Planejar o fluxo n8n JSON mínimo → PDF padronizado, destino cifrado, idempotência e auditoria; Google/OAuth2 somente após finalidade e escopos aprovados. |
