...
def montar_resumo(
    db: Session, dia: date | None = None, mes: str | None = None
) -> ResumoDashboard:
    tz = ZoneInfo(settings.app_timezone)
    agora = datetime.now(tz)

    dia_sel = dia or agora.date()
    ...
    # Limite inferior dos seletores: mes de criacao da conta (RLS -> so a
